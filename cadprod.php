   ...
   <div id='cssmenu'>
        ...
        <div id='cssmenu2'>
			...
			<div class="conteudo2">
            	...
            	<center>
                <form method="post" action="cadprodfim.php" enctype="multipart/form-data">
                    Nome <input type="text" name="modelo"/></br>
						...
						$query="select nome from marca ORDER BY nome ASC;";
                   ...
                   Classe <select name="classe">
                    ...
                    Imagem <input type="file" name="imagem"/></br>
                    	Escolha sem acentos no título</br>
                    <?php
					if(isset($_POST['marca']))
					{
