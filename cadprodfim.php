			...
			<div class="conteudo2">
                ...
                <?php
                	...
                	if(trim($_POST['modelo']) <> "")
					{
						...
						$preco= utf8_decode($_POST['reais'] . ',' .$_POST['cent']);
						$cor1= utf8_decode($_POST['cor1']);
						$cor2= utf8_decode($_POST['cor2']);
						$cor3= utf8_decode($_POST['cor3']);
					...
					{
						echo "Alguns campos não foram preenchidos e o produto não foi cadastrado!";
					}
