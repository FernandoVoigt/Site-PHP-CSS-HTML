...
<title>Sistema de Administra&ccedil;&atilde;o - Deletar</title>
...
<div id="site"> 
 ...
 <div id='cssmenu'>
       ...
       <div id='cssmenu2'>
			...
			<div class="conteudo2">
            	<center><h1>Deletar</h1></center></br></br>
            	<center>
                <form method="post" action="sistemadel.php">
                		Onde encontra-se o produto a ser deletado:
                        <select name="paginadel">
                ...
                <center>
                <?php
                	if(isset($_POST['paginadel']))
					{
						$paginadel= strtolower($_POST['paginadel']);
						
						if($paginadel == "artes marciais")
						{
							$paginadel="artes_marciais";
						}
						
						$link = mysql_connect('localhost','root','');
						mysql_select_db('loja');
						
						$query="select modelo,cod from " . $paginadel . ";";
						
						$consulta= mysql_query($query);
						echo "</br></br>";
						echo "<h1>Produtos</h1>";
						echo "</br>";
						echo '<form  method="post" action="delprod.php?table='.$paginadel.'">';
						
						while ($retorno = mysql_fetch_array($consulta))
						{
							
							echo '<input type="checkbox" name="checkbox[]" value="'. $retorno['modelo'] .'" /> '. $retorno['modelo'] . " código:" . $retorno['cod'] . '</br>';						
						}
						echo '</br></br><input type="submit" value="Deletar">';
						echo '</form>';
					}
				?>
                </center>
