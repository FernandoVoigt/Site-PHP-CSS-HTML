...
<div id="site"> 
 ...
 <div id='cssmenu'>
       ...
       <div id='cssmenu2'>
			...
			<div class="conteudo2">
            	<center><h1>Editar</h1></br></br>
                	
                <?php
						$table=$_GET['table'];
						$cod=$_GET['cod'];
						
						echo '<form action="editimgfim.php?cod='.$cod.'&table='.$table.'" method="post" enctype="multipart/form-data">
                    	<input type="file" name="imagem"></br>
						Escolha sem acentos no título</br></br>
