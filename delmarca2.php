...
<title>Sistema de Administração - Deletar</title>
   ...
   <div id='cssmenu'>
        ...
        <div id='cssmenu2'>
			...
			<div class="conteudo2">
				...
				echo "<center>As seguintes marcas foram deletadas:</br></br></ceter>";
						 				
				for($i = 0; $i < $check; $i++) 
				{
						$codmarcadel[$i]=$_POST["checkbox"][$i];
						$query2="select * from marca where cod=".$codmarcadel[$i].";";
						$exe= mysql_query($query2);
						while($retorno = mysql_fetch_array($exe))
						{
							echo ($i + 1) . "." . $retorno['nome'];
						}
						$query="delete from marca where cod= '".$codmarcadel[$i]."';" ;
				...
				{
					echo "<center>Nenhuma marca foi selecionada</center>";
				}
				?> 
			</div>
    	 <div class="rodape">
