...
<div id="site"> 
 ...
 <div id='cssmenu'>
       ...
       <div id='cssmenu2'>
			...
			<div class="conteudo2">
            	<center><h1>Deletar</h1></center></br>
                <center>
                <?php              	
						...
						echo "<h1>Marcas</h1>";
						echo "</br>";
						echo '<form  method="post" action="delmarca2.php?">';
						
						while ($retorno = mysql_fetch_array($consulta))
						{
							
							echo '<input type="checkbox" name="checkbox[]" value="'. $retorno['cod'] .'" /> '. $retorno['nome'] . " código:" . $retorno['cod'] . '</br>';						
						}
